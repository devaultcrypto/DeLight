...
GIT_REPO_ACCT=https://github.com/simpleledger  # NOTE: this account should have electrum_local as a repository for the winodws build to work!
GIT_REPO=$GIT_REPO_ACCT/Electron-Cash-SLP
